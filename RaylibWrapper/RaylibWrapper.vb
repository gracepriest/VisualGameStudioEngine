...
' ============================================================================
' UTILITY MODULE - Structures, Enums, Helper Types
' ============================================================================
Public Module Utiliy
    ...
    Public Sub DrawRectangle(rec As Rectangle, r As Byte, g As Byte, b As Byte, a As Byte)
        Framework_DrawRectangle(CInt(rec.x), CInt(rec.y), CInt(rec.width), CInt(rec.height), r, g, b, a)
    End Sub

    Public Function SliceGrid(frameW As Integer, frameH As Integer, columns As Integer, rows As Integer,
        ...
        For row = 0 To rows - 1
            For c = 0 To columns - 1
                ...
                Dim sy = marginY + row * (frameH + spacingY)
...
' ============================================================================
' UTILITY CLASSES - Handle wrappers, Sprites, Animations
' ============================================================================
Public Module UtiliyClasses
    Public NotInheritable Class TextureHandle
        ...
        Public ReadOnly Property Width As Integer
            Get
                Return Framework_GetTextureWidth(Handle)
            End Get
        End Property

        Public ReadOnly Property Height As Integer
            Get
                Return Framework_GetTextureHeight(Handle)
            End Get
        End Property
        ...
        Public Sub DrawV(pos As Vector2, Optional r As Byte = 255, Optional g As Byte = 255, Optional b As Byte = 255, Optional a As Byte = 255)
            If Not IsValid Then Exit Sub
            Framework_DrawTextureVH(Handle, pos, r, g, b, a)
        End Sub

        Public Sub DrawEx(pos As Vector2, rotation As Single, scale As Single, Optional r As Byte = 255, Optional g As Byte = 255, Optional b As Byte = 255, Optional a As Byte = 255)
            If Not IsValid Then Exit Sub
            Framework_DrawTextureExH(Handle, pos, rotation, scale, r, g, b, a)
        End Sub

        Public Sub DrawRec(src As Rectangle, pos As Vector2, Optional r As Byte = 255, Optional g As Byte = 255, Optional b As Byte = 255, Optional a As Byte = 255)
            If Not IsValid Then Exit Sub
            Framework_DrawTextureRecH(Handle, src, pos, r, g, b, a)
        End Sub

        Public Sub DrawPro(src As Rectangle, dst As Rectangle, origin As Vector2, rotation As Single, Optional r As Byte = 255, Optional g As Byte = 255, Optional b As Byte = 255, Optional a As Byte = 255)
            If Not IsValid Then Exit Sub
